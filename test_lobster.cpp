/*
  Testing program for Lobster Index

  Lobster Index is a library that inserts records in Sqlite format 3
...
void print_usage() {
  printf("\nTesting Lobster Index\n");
  printf("---------------------------\n\n");
  printf("Lobster Index is a library that inserts records in Sqlite format 3\n");
  printf("much faster than the original SQLite library.\n");
  printf("This utility is intended for testing it.\n\n");
  printf("Usage\n");
  printf("-----\n\n");
  printf("test_lobster -c <db_name.db> <page_size> <tbl_name>\n");
  ...
  printf("test_lobster -i <db_name.db> <page_size>\n");
